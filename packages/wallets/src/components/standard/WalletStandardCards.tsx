...
export default function WalletStandardCards(props: Props) {
  ...
  return (
    <WalletCards
      ...
      totalBalanceTooltip={
        <Trans>
          This is the total amount of hydrangea in the blockchain at the current peak
      ...
      spendableBalanceTooltip={
        <Trans>
          This is the amount of Hydrangea that you can currently use to make
          transactions. It does not include pending farming rewards, pending
          incoming transactions, and Hydrangea that you have just spent but is not
