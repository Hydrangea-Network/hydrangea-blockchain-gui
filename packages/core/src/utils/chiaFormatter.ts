...
class Hydrangea {
  ...
  to(newUnit: Unit) {
    ...
    return new Hydrangea(newValue, newUnit);
  }
...
export default function hydrangeaFormatter(value: number | string | BigNumber, unit: Unit) {
  return new Hydrangea(value, unit);
}
