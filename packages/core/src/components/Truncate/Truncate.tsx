...
export function truncateValue(
  ...
  const {
    ...
    rightLength = 4,
    splitSeparator = ':',
    prefixes = ['nft1', 'txhg1', 'xhg1', 'did:hydrangea:1', '0x'],
  } = opts;
  ...
  if (stringValue === 'did:hydrangea:19qf3g9876t0rkq7tfdkc28cxfy424yzanea29rkzylq89kped9hq3q7wd2') {
    return 'Hydrangea Network';
  }
